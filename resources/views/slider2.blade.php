...
<body>
    ...
    <section class="py-2 min-h-screen flex space-x-4 items-center justify-center gap-4 lg:gap-0 my-4 lg:my-0">
        <div class="container mx-auto px-4 h-full">
            <div class="flex flex-col lg:flex-row items-center justify-between gap-8 w-full h-full">
